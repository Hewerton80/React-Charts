    ...
    return (
		<div>
			<Navbar bg="dark" variant="dark">
				...
				<Navbar.Brand href="/">CanvasJS Examples - Hewerton Adão</Navbar.Brand><span className="hidden-xs text-muted">React</span>
			  </Navbar>		  
			  <BrowserRouter>		  
					<Row>
						...
						<Nav to="/" className="flex-sm-column" id="sidebar">
							<ListGroup className="nav nav-sidebar flex-sm-column">
								<ListGroup.Item>
									<a href="#overview" data-toggle="collapse" aria-expanded="true" className="dropdown-toggle"><span>OVERVIEW</span></a>
								</ListGroup.Item>
								<ListGroup>
									<ListGroup className="sub-menu" id="overview">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="lineCharts">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="areaCharts">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="columnCharts">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="pieCharts">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="financialCharts">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="scatterCharts">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="boxAndWhiskerCharts">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="combinationCharts">
								...
								<ListGroup>
									<ListGroup className="sub-menu" id="dynamicCharts">
